...
AC_ARG_WITH(
		apache,
		[  --with-apache[=DIR]     Apache instal root],
...
int main (int argc, char *argv[])
{
		...
		((major2 == major1) && (minor2 == minor1) && (micro2 >= micro1)))
	{
		...
		printf("*** of apache with the --with-apache configure option. and remove\n");
		printf("*** the config.cace file before rerunning configure\n");
		return 1;
	}
}
